...
char *convert_expression_to_postfix(char const *str);
ErrorCode plot_postfix(char const *postfixExpression);
...
ErrorCode plot_postfix(char const *const postfixExpression) {
    if (postfixExpression == NULL) {
        fprintf(stderr,
